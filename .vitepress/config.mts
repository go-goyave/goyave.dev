...
export default defineConfig({
    ...
    head: [
        ...
        [
            "meta",
            {
                ...
                content: `https://goyave.dev/goyave_banner.png`,
            },
        ],
    ...
    transformHead: ({ pageData }) => {
        ...
        const title = pageData.frontmatter.title
            ? pageData.frontmatter.title + " | Goyave"
            : "Goyave";
    ...
    themeConfig: {
        ...
        nav: [
            {
                text: "pkg.go.dev",
                link: "https://pkg.go.dev/goyave.dev/goyave/v5",
            },
        ],
        ...
        sidebar: [
            ...
            },
            {
                ...
                items: [
                    {
                        text: "DTO and model mapping",
                        link: "/advanced/dto-and-model-mapping",
                    },
                    {
                        text: "Error handling",
                    ...
                    {
                        text: "Status handlers",
                        link: "/advanced/status-handlers",
                    },
            ...
            {
                text: "Libraries",
                items: [{ text: "Filter", link: "/libraries/filter" }],
            },
        ],
